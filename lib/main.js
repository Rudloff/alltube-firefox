...
function openAudio(info) {
    'use strict';
    tabs.open('http://alltubedownload.net/api.php?audio=on&url=' + encodeURI(info.webpage_url));
}

function openInfo(info) {
    'use strict';
    tabs.open('http://alltubedownload.net/api.php?url=' + encodeURI(info.webpage_url));
}
