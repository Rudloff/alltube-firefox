...
function getJSON(callback) {
    ...
    var url = tabs.activeTab.url,
        req = new Request({
            url: prefs.prefs['alltube-url'] + "/json.php?url=" + encodeURIComponent(url),
...
function openAudio(info) {
    'use strict';
    tabs.open(prefs.prefs['alltube-url'] + '/api.php?audio=on&url=' + encodeURIComponent(info.webpage_url));
}

function openInfo(info) {
    'use strict';
    tabs.open(prefs.prefs['alltube-url'] + '/api.php?url=' + encodeURIComponent(info.webpage_url));
}
