...
function openAudio(info) {
    'use strict';
    tabs.open(prefs.prefs['alltube-url'] + '/video?audio=on&url=' + encodeURIComponent(info.webpage_url));
}

function openInfo(info) {
    'use strict';
    tabs.open(prefs.prefs['alltube-url'] + '/video?url=' + encodeURIComponent(info.webpage_url));
}
